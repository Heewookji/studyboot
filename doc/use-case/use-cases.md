...
### [스터디룸 조회](sangmin/uc-스터디공간조회.md)(비회원, 회원)
- 비회원 및 회원이 스터디 공간을 조회하는 것

### [아이디 혹은 비밀번호 찾기](jihwan/uc-idPwFind.md)(회원)
- 회원이 로그인을 하는 것
...
### [회원탈퇴](hyunwoo/회원탈퇴.md)(회원)
- 회원이 서비스에서 탈퇴하는 것.

### [개인정보 관리](jihwan/uc-MyInformation.md)(회원)
- 회원이 개인 정보를 조회, 수정 하는 것

### [개인 일정 조회](hyunwoo/일정조회.md)(회원)
- 회원이 개인 일정을 조회하는 것

### [개인 자료실 관리 시스템](sangmin/uc-개인자료실관리.md)(회원)
- 회원이  개인 자료실을 등록, 조회, 수정, 삭제하는 것
...
### [관리자에게 문의하기](sanghyun/uc-관리자에게문의및신고.md)(회원)
- 회원이 관리자에게 문의하는 것

### [쪽지관리시스템](hyunwoo/쪽지관리.md)(회원)
- 회원이 쪽지를 관리하는 것

### [스터디 자료실 관리 시스템](sangmin/uc-스터디자료실관리시스템.md)(회원)
- 스터디에 가입한 회원이  자료실을 등록, 조회, 수정, 삭제하는 것
...
### [스터디 완료자 서로 평가](heewook/uc-완료자서로평가.md)(스터디원)
- 스터디가 완료됐을 때, 구성원들이 서로 평가 등록하는 것.

### [스터디 그룹 탈퇴 및 스터디원 평가하기](sanghyun/uc-스터디그룹탈퇴및평가.md)(스터디원)
- 스터디원이 스터디 그룹을 탈퇴하면서 다른 스터디원들을 평가하는 것

### [스터디 게시판 관리](sanghyun/uc-스터디게시판관리.md)(스터디장, 스터디원)
- 스터디원이 게시판의 글을 등록, 조회, 수정, 삭제 하는 것

### [스터디 그룹의  정보 조회](jihwan/uc-StudyMemberViewManagement.md)(스터디원, 스터디장)
- 스터디원이 그룹의 다른 스터디원 정보를 조회, 신고, 쪽지송신하는 것
- 스터디장의 경우 스터디원을 조회, 신고, 쪽지, 추방, 위임 하는 것

### [스터디 일정 관리](heewook/uc-스터디일정.md)(스터디원, 스터디장)
- 스터디원이 그룹의 일정을 등록, 조회, 수정, 삭제 하는 것

### [스터디 일정 출석](heewook/uc-스터디 일정 출석관리.md)(스터디원, 스터디장)
- 스터디장이 그룹의 출석을 등록 하는 것

### [스터디공간 관리](heewook/uc-스터디공간 예약관리.md)(스터디장)
- 스터디원이 스터디 공간을 예약, 예약취소 하는 것

### [스터디공간 후기](heewook/uc-스터디공간 후기.md)(스터디장)
- 스터디원이 스터디 공간후기를 등록,변경,삭제 하는 것
...
### [관리자 고객센터 관리](sanghyun/uc-관리자고객센터관리.md)(관리자)
