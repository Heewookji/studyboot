...
insert into sms_rprt_inqry (rprt_inqry_id, cls_id, inqry_id, sspct_id, cont)
  ...
  values (1,101,1,2,'2019-05-17 09:00','2019-05-17 09:50');
   insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 10:00','2019-05-17 10:50');
    insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 11:00','2019-05-17 11:50');
   insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 12:00','2019-05-17 12:50');
    insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 13:00','2019-05-17 13:50');
   insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 14:00','2019-05-17 14:50');
     insert into sms_space_room_bkng ( space_room_id, space_id, std_id, member_id, bkng_sdt, bkng_edt)
  values (1,101,1,2,'2019-05-17 20:00','2019-05-17 20:50');
